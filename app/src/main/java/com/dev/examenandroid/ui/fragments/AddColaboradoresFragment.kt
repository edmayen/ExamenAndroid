 ...
 * Use the [AddColaboradoresFragment.newInstance] factory method to
...
class AddColaboradoresFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddColaboradoresFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddColaboradoresFragment().apply {
